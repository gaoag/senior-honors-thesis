...
for (industry in c("51", "511", "512", "515", "516", "517", "518", "519")) {
  ...
  lq_estabs_lm = estimatr::lm_robust(lq_annual_avg_estabs ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
  lq_empl_lm = estimatr::lm_robust(lq_annual_avg_emplvl ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
  lq_pay_lm = estimatr::lm_robust(lq_avg_annual_pay ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
  estabs_lm = estimatr::lm_robust(annual_avg_estabs ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
  empl_lm = estimatr::lm_robust(annual_avg_emplvl ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
  pay_lm = estimatr::lm_robust(avg_annual_pay ~ treated_general_dummy + post_dummy + did, data=msa_df, cluster=area_fips)
