...
for (industry in c("51", "511", "512", "515", "516", "517", "518", "519")) {
  ...
  lq_estabs_lm = estimatr::lm_robust(lq_annual_avg_estabs ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  lq_empl_lm = estimatr::lm_robust(lq_annual_avg_emplvl ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  lq_pay_lm = estimatr::lm_robust(lq_avg_annual_pay ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  estabs_lm = estimatr::lm_robust(annual_avg_estabs ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  empl_lm = estimatr::lm_robust(annual_avg_emplvl ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  pay_lm = estimatr::lm_robust(avg_annual_pay ~ did + factor(State.Name) + factor(year), data=msa_df, cluster=area_fips)
  
  stfe_pooled_models[[industry]] = list(lq_estabs_lm, lq_empl_lm, lq_pay_lm, estabs_lm, empl_lm, pay_lm)
}
...
for (industry in c("51", "511", "512", "515", "516", "517", "518", "519")) {
  ...
  stfe_pooled_models_separated_regional[[industry]] = list(lq_estabs_lm, lq_empl_lm, lq_pay_lm, estabs_lm, empl_lm, pay_lm)
}
...
for (industry in c("51", "511", "512", "515", "516", "517", "518", "519")) {
  ...
  stfe_pooled_models_separated_supercomputing[[industry]] = list(lq_estabs_lm, lq_empl_lm, lq_pay_lm, estabs_lm, empl_lm, pay_lm)
}


summaries_pooled_models = lapply(pooled_models[["51"]], summary)




save(pooled_models, file="basic_pooled_models.RData")
save(pooled_models_separated_regional, file="pooled_models_only_regional.RData")
save(pooled_models_separated_supercomputing, file="pooled_models_only_supercomputing.RData")
